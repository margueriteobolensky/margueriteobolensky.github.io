...
**Homeward Bound: How Migrants Seek Out Familiar Climates [New Draft Coming Soon]**  
...
This paper examines the concept of ``climate matching'' in migration---the idea that migrants seek out destinations with familiar climates. Focusing on the US, we document that temperature distance between origin and destination strongly predicts the distribution of migrants across counties. This pattern holds for internal and international migration in the past (1850-1940) and today (2010-2021), and is not explained by the spatial correlation of climate or the persistence of ethnic networks. We provide suggestive evidence for two mechanisms driving climate matching: climate-specific skills and climate-as-amenity. Then, we study the implications of climate matching for migrants. Leveraging plausibly exogenous variation in climate mismatch, we document that climate distance reduces life expectancy among immigrants, and increases mortality rates for their US-born children. We calculate the implied mortality cost of a 1\degree{}C change in climate to be \$2,625-2,700.%, which equates to 3-5\% of GDP if applied to all Americans.

</div>



**Protect or Prepare: Designing Crop Insurance Subsidies for a Changing Climate [JMP]** 
...
Governments increasingly subsidize insurance against weather shocks in response to growing climate risks, but these subsidies may reduce incentives for long-term adaptation. This paper quantifies the impact of crop insurance subsidies on U.S. agricultural adaptation using a dynamic land use and insurance choices model, incorporating climate projections and crop yield models for the three main U.S. crops alongside detailed micro-data on farmers' decisions. Current spatially uniform subsidies allocate most funds to high-risk regions, reducing welfare by encouraging farming in areas more susceptible to climate shocks. In contrast, targeted subsidies, which adjust based on regional climate risk trends, improve welfare by reducing production volatility. However, the optimal policy, which removes subsidies from high-risk areas and doubles them in low-risk regions, risks regional disparities and drastically reduces crop diversity by encouraging corn production. These results underscore the importance of aligning agricultural policies with climate dynamics to promote sustainable land use and minimize climate-related welfare losses.
